import React, { Dispatch, MouseEvent, FC, SetStateAction, useRef, useState } from "react";
import {
  CalendarIcon,
  EmojiHappyIcon,
  LocationMarkerIcon,
    ...
    <div className="flex space-x-2 p-5">
      ...
      <div className="flex flex-1 items-center pl-2">
        <form className="flex flex-1 flex-col">
          ...
          {image && (
            <img className="mt-10 h-40 w-full rounded-xl object-contain shadow-lg" src={image} alt="image"/>
          )}
        </form>
      </div>
    </div>
